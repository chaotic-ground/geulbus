...
- [x] 입력 항목 전환(home↔직전 항목 토글, 직전 비-home 항목 기억) + 로마자 항목 글쇠 리매핑(드보락 등)
...
- `IME_SWITCH` 글쇠(**한글 키 / CapsLock** 등)는 **home(한글) 항목 ↔ 직전에 쓰던 비-home
  항목** 사이를 토글합니다. 비-home 에서 누르면 항상 home 으로 가고(그 항목을 기억), home
  에서 누르면 기억해 둔 직전 항목으로 갑니다. 한글 항목은 조합, 로마자 항목은 글쇠 리매핑,
  키표 없는 항목은 패스스루합니다.
